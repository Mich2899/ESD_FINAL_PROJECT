...
/**
  ******************************************************************************
  * @brief	Reads a value of register
  * @param	reg - number of register to read
...
/**
  ******************************************************************************
  * @brief	Writes a new value to the register
  * @param	reg - number of register to read
...
/**
  ******************************************************************************
  * @brief	Writes a buffer to a multi-byte register
...
/**
  ******************************************************************************
  * @brief	Configures the transceiver to its initial state
  * @param	None
  * @retval	None
  ******************************************************************************
  */
...
/**
  ******************************************************************************
  * @brief	Checks the presence of the nRF24L01
  * @param	None
  * @retval	zero - transceiver is absent
...
/**
  ******************************************************************************
  * @brief	Set transceiver power mode
...
/**
  ******************************************************************************
  * @brief	 Set RF frequency channel
  * @param	 channel - radio frequency channel, can be a value from 0 to 127
  * @retval	None
  ******************************************************************************
  */
...
/**
  ...
  * @param	 pipe - pipe to configure address, one of nRF24_PIPEx values
...
/**
  ...
  * @param	 None
  * @retval	 the length of the address configured in the transceiver,
  *          value from 3 to 5
  ******************************************************************************
  */
...
/**
  ...
  * @retval	 one of nRF24_RX_xx values
